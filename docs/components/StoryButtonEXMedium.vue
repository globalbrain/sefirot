...
<StoryBase title="Medium Buttons">
  <div class="list">
    <div class="item">
      <SButton label="PRIMARY" size="medium" />
    </div>
    <div class="item">
      <SButton label="SECONDARY" type="secondary" size="medium" />
    </div>
    <div class="item">
      <SButton label="TEXT" type="text" size="medium" />
    </div>
    <div class="item">
      <SButton label="MUTE" type="mute" size="medium" />
    </div>
  </div>
</StoryBase>
