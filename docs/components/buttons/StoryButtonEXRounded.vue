...
<StoryBase title="Rounded Button">
  <div class="list">
    ...
    <div class="item">
      <SButton label="SECONDARY" type="secondary" rounded />
    </div>
    <div class="item">
      <SButton label="TERTIARY" type="tertiary" rounded />
    </div>
    <div class="item">
      <SButton label="TEXT" type="text" rounded />
    </div>
    <div class="item">
      <SButton label="MUTE" type="mute" rounded />
    </div>
  </div>
</StoryBase>
