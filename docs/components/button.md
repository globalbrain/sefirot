...
```vue-html
<SButton icon-mode="info" label="Button" />
```
...
:root {
  ...
  --button-fill-neutral-icon-color: var(--c-text-1);
  ...
  --button-fill-neutral-disabled-icon-color: var(--c-text-2);
  ...
  --button-fill-white-icon-color: var(--c-text-dark-1);
  ...
  --button-fill-white-disabled-icon-color: var(--c-text-dark-2);
  ...
  --button-fill-black-icon-color: var(--c-text-light-1);
  ...
  --button-fill-black-disabled-icon-color: var(--c-text-light-2);
  ...
  --button-fill-mute-icon-color: var(--c-text-2);
  ...
  --button-fill-mute-disabled-icon-color: var(--c-text-3);
  ...
  --button-fill-info-icon-color: var(--c-info-text);
  ...
  --button-fill-info-disabled-icon-color: var(--c-info-text-dark);
  ...
  --button-fill-success-icon-color: var(--c-success-text);
  ...
  --button-fill-success-disabled-icon-color: var(--c-success-text-dark);
  ...
  --button-fill-warning-icon-color: var(--c-warning-text);
  ...
  --button-fill-warning-disabled-icon-color: var(--c-warning-text-dark);
  ...
  --button-fill-danger-icon-color: var(--c-danger-text);
  ...
  --button-fill-danger-disabled-icon-color: var(--c-danger-text-dark);
  ...
  --button-outline-neutral-icon-color: var(--c-text-1);
  ...
  --button-outline-neutral-disabled-icon-color: var(--c-text-2);

  --button-outline-white-border-color: var(--c-neutral-dark-1);
  --button-outline-white-text-color: var(--c-text-dark-1);
  --button-outline-white-icon-color: var(--c-text-dark-1);
  ...
  --button-outline-white-disabled-icon-color: var(--c-text-dark-2);

  --button-outline-black-border-color: var(--c-neutral-light-1);
  --button-outline-black-text-color: var(--c-text-light-1);
  --button-outline-black-icon-color: var(--c-text-light-1);
  ...
  --button-outline-black-disabled-icon-color: var(--c-text-light-2);

  --button-outline-mute-border-color: var(--c-divider-1);
  --button-outline-mute-text-color: var(--c-text-2);
  --button-outline-mute-icon-color: var(--c-text-2);
  ...
  --button-outline-mute-disabled-icon-color: var(--c-text-3);

  --button-outline-info-border-color: var(--c-info-light);
  --button-outline-info-text-color: var(--c-info-text);
  --button-outline-info-icon-color: var(--c-info-text);
  ...
  --button-outline-info-disabled-icon-color: var(--c-info-text-dark);

  --button-outline-success-border-color: var(--c-success-light);
  --button-outline-success-text-color: var(--c-success-text);
  --button-outline-success-icon-color: var(--c-success-text);
  ...
  --button-outline-success-disabled-icon-color: var(--c-success-text-dark);

  --button-outline-warning-border-color: var(--c-warning-light);
  --button-outline-warning-text-color: var(--c-warning-text);
  --button-outline-warning-icon-color: var(--c-warning-text);
  ...
  --button-outline-warning-disabled-icon-color: var(--c-warning-text-dark);

  --button-outline-danger-border-color: var(--c-danger-light);
  --button-outline-danger-text-color: var(--c-danger-text);
  --button-outline-danger-icon-color: var(--c-danger-text);
  ...
  --button-outline-danger-disabled-icon-color: var(--c-danger-text-dark);

  --button-text-neutral-text-color: var(--c-text-1);
  --button-text-neutral-icon-color: var(--c-text-1);
  ...
  --button-text-neutral-disabled-icon-color: var(--c-text-2);

  --button-text-white-text-color: var(--c-text-dark-1);
  --button-text-white-icon-color: var(--c-text-dark-1);
  ...
  --button-text-white-disabled-icon-color: var(--c-text-dark-2);

  --button-text-black-text-color: var(--c-text-light-1);
  --button-text-black-icon-color: var(--c-text-light-1);
  ...
  --button-text-black-disabled-icon-color: var(--c-text-light-2);

  --button-text-mute-text-color: var(--c-text-2);
  --button-text-mute-icon-color: var(--c-text-2);
  ...
  --button-text-mute-disabled-icon-color: var(--c-text-3);

  --button-text-info-text-color: var(--c-info-text);
  --button-text-info-icon-color: var(--c-info-text);
  ...
  --button-text-info-disabled-icon-color: var(--c-info-text-dark);

  --button-text-success-text-color: var(--c-success-text);
  --button-text-success-icon-color: var(--c-success-text);
  ...
  --button-text-success-disabled-icon-color: var(--c-success-text-dark);

  --button-text-warning-text-color: var(--c-warning-text);
  --button-text-warning-icon-color: var(--c-warning-text);
  ...
  --button-text-warning-disabled-icon-color: var(--c-warning-text-dark);

  --button-text-danger-text-color: var(--c-danger-text);
  --button-text-danger-icon-color: var(--c-danger-text);
  ...
  --button-text-danger-disabled-icon-color: var(--c-danger-text-dark);
}
```
