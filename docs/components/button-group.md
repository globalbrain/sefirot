...
Wrap `<SButton>` with `<SButtonGroup>` component. Currently, it does not support button types other than `:type="fill"`. If you pass buttons of other types, the style may become corrupted.
